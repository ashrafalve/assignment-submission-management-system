...
namespace AssignmentManagement.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260806034732_AddUserClassRelationship")]
    partial class AddUserClassRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AssignmentManagement.Api.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            PasswordHash = "$2a$12$SF.hwasTmCVYV2j9eyLsB.gD.re/sZC7NyP1JmqnPWa51/Bf0fMW6",
                            Role = "Admin"
                        });
                });
